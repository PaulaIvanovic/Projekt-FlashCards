...
INSERT INTO `card` (`idcard`, `title`, `paragraph`, `T/F`, `idsubgroup`, `boja`) VALUES
(1, 'foo', 'lorem ipsum lkasdjflsadj lfsjd lfčjasdčlfj lasdjflsdkjflsdjfl kdjfalksdjflas', NULL, 1, NULL);
...
INSERT INTO `grupa` (`idgroup`, `name`, `iduser`, `boja`) VALUES
(1, 'Ostalo', NULL, NULL);
